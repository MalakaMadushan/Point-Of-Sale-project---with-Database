...
//        calculateTotal();
    ...
    @FXML
    private void btnRemoveOnAction(ActionEvent actionEvent) throws SQLException {
...
//        calculateTotal();
    ...
    private void btnPlaceOrderOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        Order order = new Order(txtOrderID.getText(), txtOrderDate.getValue(),txtCustomerId.getText(),orderDetails);
        ManageOrders.createOrder(order);
    ...
    private void hardReset() throws SQLException {
        reset();
    ...
    @FXML
    private void txtItemCode_OnAction(ActionEvent actionEvent) throws SQLException {
    ...
    @FXML
    private void txtQty_OnAction(ActionEvent actionEvent) throws SQLException {
        btnSaveOnAction(actionEvent);
    }

    private Item validateItemCode() throws SQLException {
    ...
    private void synchronizeQty(String itemCode) throws SQLException {
