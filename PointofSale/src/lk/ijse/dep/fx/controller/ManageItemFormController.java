...
public class ManageItemFormController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ArrayList<Item> itemsDB = null;
        try {
            itemsDB = ManageItems.getItemsDB();
    ...
    private void btnSave_OnAction(ActionEvent event) throws SQLException {
        ...
        if (tblItems.getSelectionModel().isEmpty()) {
            ...
            //Item item = new Item(txtItemCode.getText(), txtDescription.getText(),
                    //Double.parseDouble(txtUnitPrice.getText()),Integer.parseInt(txtQty.getText()));
            ManageItems.createItem(txtItemCode.getText(),txtDescription.getText(),Double.parseDouble(txtUnitPrice.getText()),Integer.parseInt(txtQty.getText()));
            ...
            ManageItems.updateItem(txtItemCode.getText(),txtDescription.getText(),Double.parseDouble(txtUnitPrice.getText()),Integer.parseInt(txtQty.getText()));
...
//        }
    ...
    public void btnReport_OnAction(ActionEvent actionEvent) throws JRException, SQLException {
        File file = new File("JasperReports/ItemDetails.jasper");

        JasperReport compilereport = (JasperReport) JRLoader.loadObject(file);
        HashMap<String, Object> para = new HashMap<>();

        String absolutePath = new File("JasperReports/images/items.png").getAbsolutePath();
        para.put("imagepath2",absolutePath);
