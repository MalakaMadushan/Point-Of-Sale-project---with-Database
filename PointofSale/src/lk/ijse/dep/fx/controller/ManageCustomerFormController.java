...
public class ManageCustomerFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList<Customer> customersDB = null;
        try { customersDB = ManageCustomers.getCustomerDB();
    ...
    private void btnSave_OnAction(ActionEvent event) throws SQLException {
        ...
        if (tblCustomers.getSelectionModel().isEmpty()) {
            ...
            ManageCustomers.createCustomer(txtCustomerId.getText(),txtCustomerName.getText(),txtCustomerAddress.getText());
            ...
            ManageCustomers.updateCustomer(txtCustomerId.getText(),
    ...
    public void btnReport_OnAction(ActionEvent actionEvent) throws JRException, SQLException {
        File file = new File("JasperReports/CustomerDetails.jasper");
        System.out.println(file.getAbsolutePath());
        JasperReport compilereport = (JasperReport) JRLoader.loadObject(file);
        HashMap<String, Object> para = new HashMap<>();

        String absolutePath = new File("JasperReports/images/customer.png").getAbsolutePath();
        para.put("imagepath",absolutePath);
